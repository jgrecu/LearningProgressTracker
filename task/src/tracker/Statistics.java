...
public class Statistics {
    private Set<Integer> javaStudents = new LinkedHashSet<>();
    private Set<Integer> dsaStudents = new LinkedHashSet<>();
    private Set<Integer> dbStudents = new LinkedHashSet<>();
    private Set<Integer> springStudents = new LinkedHashSet<>();
    ...
    public void addJavaStudents(int studentId) {
        this.javaStudents.add(studentId);
    }

    public void addDsaStudents(int studentId) {
        this.dsaStudents.add(studentId);
    }

    public void addDbStudents(int studentId) {
        this.dbStudents.add(studentId);
    }

    public void addSpringStudents(int studentId) {
        this.springStudents.add(studentId);
    }

    public void addTasks(int id, int jT, int dsaT, int dbT, int sT) {
        if (jT != 0) {
